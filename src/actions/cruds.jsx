  ...
  return function(dispatch, getState) {
    ...
    return gAxios(
      ...
      .catch(function(r) {
        ...
        dispatchAlert(
          dispatch,
          "Erreur serveur : " + (r.response ? r.response.status : "")
        ); //call dispatchAlert action
...
export const getData = (n, url) => {
  ...
  return function(dispatch, getState) {
    ...
    return gAxios(getState().app.token, getState().app.config.url + url)
      .then(function(r) {
        dispatch({
...
export const postData = (n, url, data) => {
  return function(dispatch, getState) {
    ...
    return gAxios(
      ...
      .finally(function(r) {
        dispatch({ type: types.APP_LOADING, payload: false });
      }); //call reducer to set loading to "false"(stop loading)
  };
};
...
export const putData = (n, url, id, data) => {
  return function(dispatch, getState) {
    ...
    return gAxios(
      getState().app.token,
      getState().app.config.url + url + id,
      "put",
      data
    )
      .then(function(r) {
